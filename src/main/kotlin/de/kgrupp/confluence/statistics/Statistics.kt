...
class Statistics {
    ...
    fun get(confluenceSpaces: List<String>, minCreatedDate: LocalDate, maxCreatedDate: LocalDate?, recentBlogPostsMinDate: LocalDate) {
        ...
        println("Data loaded!")
        authorStatistics.convertToMarkdown(minCreatedDate, recentBlogPostsMinDate).writeToFile(File("statistics.md"))
